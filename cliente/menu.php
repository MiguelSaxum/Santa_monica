...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo">
         <h1>SANTA MÓNICA- <?php echo $_SESSION["usuario"]." ".$_SESSION["apellido"]; ?></h1>
        </div>
...
<ul class="nav nav-tabs">
  <li class="active"><a style="color: #000000" href="menu.php">Cliente</a></li>
  

</ul>


<a type="button" class="btn btn-large btn-success" data-toggle="modal" data-target="#ModalAgregar"><i class='glyphicon glyphicon-plus'></i>AGREGAR CLIENTE</a>
...
<?php
$sql = "SELECT * FROM cliente WHERE dpto = $idDep";
