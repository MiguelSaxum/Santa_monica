...
";
    ...
    <?php
        ...
        <td><button <?php echo "href='upocompra.php?id=$id' "?> type="button" class="btn btn-large btn-primary" data-toggle="modal" data-target="#ModalEditar"><i class='fa fa-check'></i>Confirmar</button>
        </td>
        </tr>
  <?php  }
} else {
