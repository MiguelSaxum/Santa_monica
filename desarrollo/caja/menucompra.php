...
<div class="templatemo-charts">
  ...
  <a style="color: #000000" href="menu.php">Recibos de Egreso</a>
...
<?php
$sql = "SELECT * FROM listacompra inner join proveedor on idProveedor = id_proveedor inner join producto on idProducto = id_producto where status = 0";
...
";
    ...
    <?php
        ...
        <?php $id=$row["idListaCompra"]; ?>
        <td><button <?php echo "href='upcompra.php?id=$id' "?> type="button" class="btn btn-large btn-primary" data-toggle="modal" data-target="#ModalEditar"><i class='fa fa-check'></i> Confirmar</button>
        </td>
        <td>
        <button <?php echo "href='delcompra.php?id=$id' "?> type="button" class="btn btn-large btn-danger" data-toggle="modal" data-target="#ModalELIMINAR"><i class='fa fa-times'></i> Cancelar</button>
