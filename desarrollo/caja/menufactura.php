...
<?php
$sql = "SELECT * FROM listaventa inner join cliente on idCliente = id_clientes  inner join producto on idProducto = id_producto where status = 0 and iva = 1";
...
";
    ...
    <?php
        ...
        <td><button <?php echo "href='upfactura.php?id=$id' "?> type="button" class="btn btn-large btn-primary" data-toggle="modal" data-target="#ModalEditar"><i class='fa fa-check'></i>Confirmar</button>
        </td>
        </tr>
  <?php  }
} else {
