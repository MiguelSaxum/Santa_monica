...
<ul class="nav nav-tabs">
  <li class="active"><a style="color: #000000" href="menu.php">Usuarios</a></li>
  

</ul>


<a type="button" class="btn btn-large btn-success" data-toggle="modal" data-target="#ModalAgregar"><i class='glyphicon glyphicon-plus'></i> Agregar Usuario</a>
