...
<ul class="nav nav-tabs">
  <li class="active"><a style="color: #000000" href="menu.php">Tipo de Gasto</a></li>
  

</ul>


<a type="button" class="btn btn-large btn-success" data-toggle="modal" data-target="#ModalAgregar"><i class='glyphicon glyphicon-plus'></i> AGREGAR TIPO DE GASTO</a>
...
<?php
$sql = "SELECT * FROM rubro inner join departamento on rubro.idDep=departamento.id_departamento";
...
";
    ...
    <?php
        ...
        <?php $id=$row["idRubro"]; ?>
        <td><button <?php echo "href='up.php?id=$id' "?> type="button" class="btn btn-large btn-primary" data-toggle="modal" data-target="#ModalEditar"><i class='glyphicon glyphicon-edit'></i>EDITAR</button>
        </td>
        <td>
        <button <?php echo "href='del.php?id=$id' "?> type="button" class="btn btn-large btn-danger" data-toggle="modal" data-target="#ModalELIMINAR"><i class='glyphicon glyphicon-remove'></i>ELIMINAR</button>
