...
<div class="cuadrado" style="height: 80px"> <p style="margin-top: 30px"><b >
  <?php $vari=$row['gtotal'];
echo "Recibi la cantidad de: $".number_format($vari, 2);
?>
<br>Importe Letra    SON:</b>&nbsp;&nbsp;&nbsp;&nbsp;  <?php
...
<TABLE BORDER>
	<TR>
		<TD><p ><b >Correspondiente a la Compra:</b>ODC-<?php echo $row["id_gastos"];?>
</p></TD>
	
		<TD><p ><b >Solicitado Por: </b><?php echo $row["solicita"];?></p></TD>
	</TR>
	<TR>
		<TD><p ><b >Para el Departamento:</b><?php echo $row["nomDep"];?></p></TD> <TD><p ><b >Lo Requiere : </b><?php echo $row["requiere"];?></p></TD>
	</TR>
</TABLE>
...
<TABLE BORDER>
	<TR><TH>CANTIDAD</TH>
		<TH>UDEM</TH> <TH>DESCRIPCION</TH> <TH>TOTAL</TH></TR>
	<TR><TD><?php echo number_format($row["tcant"]);?></TD>
		<TD><?php echo $row["um"];?></TD> <TD><?php echo $row["concepto"];?></TD> <TD>$<?php echo number_format($vari, 2);?></TD></TR>
...
<div class="cuadrado" style="float: left;margin-top: 10px,10px;margin-right: 10px;width: 210">
<p style="padding-bottom: 50px"> ENTREGADO POR</p>
...
<div class="cuadrado" style="float: left ;margin-top: 10px,10px;margin-right: 10px;width: 210">
<p style="padding-bottom: 50px"> AUTRIZADO POR</p>
...
<div class="cuadrado" style="float: left;margin-top: 10px,10px;margin-right: 10px;width: 210">
	<P style="padding-bottom: 50px">RECIBIDO POR</P>
<P>_______________________</P>
<P>NOMBRE Y FIRMA</P>	
</div>
<?php }?>
