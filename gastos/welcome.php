		<?php
			...
			include("../conect.php");
				...
				$sql = "INSERT INTO `gastos` (`departamento_id_departamento`, `concepto`, `fecha`, `solicita`, `requiere`, `unidadMedida`, `status`, `id_proveedor`) VALUES ('$departamento_id_departamento', '$concepto', NOW(), '$solicita', '$requiere',  '$unidadMedida', '0','$proveedor')";
