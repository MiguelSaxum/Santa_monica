...
<div><p><img  style="float:left; margin:10px;" src="../opesa.jpg"> <h3 style="float: right">BOLETA DE VENTA: <?php echo $row['idListaVenta'];?><br>
...
<table  style="margin-bottom: 0px;">
	...
	<TR>
		<TD><p ><b >FOLIO:</b></td><td><?php echo $row['idListaVenta'];?></td><TD><p ><b >FECHA DE SALIDA:</b></td><td><?php echo $row['fechaSalida'];?></td>
</p></TR>
	<TR>
...
<TR>
		<TD colspan="2"><p ><b >PRECIO:</b></td><td colspan="2"><?php echo $row['precio_venta'];?></td>
</p></TR>
...
<TR>
		<TD colspan="2"><B>TOTAL A PAGAR ANTES DE IVA</B></td><td colspan="2" style="text-align: right;">$ <?php echo $row['totalCobrar'];?></td>
</p></TR>
<TR>
		<TD colspan="4"><p ><b >________________________________________________</b></td>
</p></TR>
