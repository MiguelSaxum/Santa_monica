...
<div class="cuadrado" style="float: right;margin-top: 20px,0px;margin-right: 20px">
  <table border="0">
  <TR>
    <TD>Fecha</TD> 
  </TR>
...
<div class="cuadrado" style="float: right;margin-top: 10px,20px;margin-right: 20px;width: 100px">
  <table border=".1">
  <tr >
    <TD>Folio</TD> 
  </tr>
  <TR>
    <TD><?php echo $row["idListaCompra"];?></TD> 
  </TR>
</table></div>
<?php $vari=$row['totalPagar'];

?>
<div class="cuadrado" style="height: 100px"> <p style="margin-top:   0px">
<?php
echo "<h2 style='margin: 0px'>$ ";
echo number_format($vari, 2, '.', ','); 
echo "</h2><br>  ";

?>
<b >Importe Letra    SON:</b>&nbsp;&nbsp;&nbsp;&nbsp;  <?php
...
<table style="margin-bottom: 100px">
  <TR>
    <TD><p ><b >Correspondiente a la Boleta Numero:</b>3494
</p></TD>
  
    <TD><p ><b >A Nombre de : </b><?php echo $row["nombre"];?></p></TD>
  </TR>
  <TR>
    <TD><p ><b >Por el Concepto de:</b> <?php echo $row["neto"];?> <?php echo $row["unidadMed"];?> DE <?php echo $row["nombre_producto"];?>  </p></TD> <TD><p ><b >Forma De Pago : </b><?php echo $row["metodo"];?></p></TD>
  </TR>
</TABLE>


<div class="cuadrado" style="float: right;margin-top: 10px,20px;margin-right: 10px;width: 250px">
...
<div class="cuadrado" style="float: left;margin-top: 10px,10px;margin-right: 10px;width: 250px">
