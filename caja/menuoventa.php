...
<ul class="nav nav-tabs">
  <li class="active"><a style="color: #000000" href="menu.php">Ordenes de Ingreso</a></li>
...
<?php
$sql = "SELECT * FROM ingresos where status = 0";
...
";
    ...
    <?php
        ...
        <td><button <?php echo "href='upoventa.php?id=$id' "?> type="button" class="btn btn-large btn-primary" data-toggle="modal" data-target="#ModalEditar"><i class='fa fa-check'></i>Confirmar</button>
        </td>
        </tr>
  <?php  }
} else {
