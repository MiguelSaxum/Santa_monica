...
<ul class="nav nav-tabs">
  <li class="active"><a style="color: #000000" href="menu.php">Facturas Expiradas</a></li>
...
$sql = "SELECT *, DATEDIFF(fechaEx, CURDATE()) as dif FROM listaventa inner join cliente on idCliente = id_clientes  inner join producto on idProducto = id_producto where status = -1";
