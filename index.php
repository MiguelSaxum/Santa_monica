...
<body>
  <div class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        <div class="logo"><h1>SANTA MÓNICA - <?php echo $_SESSION["usuario"]." ".$_SESSION["apellido"]; ?></a> </h1></div>
        ...
        <ul class="templatemo-sidebar-menu">
          ...
          if ( $n == 4 or $n == 1 ) {
            ...
            <ul class='templatemo-submenu'>
              ...
              <li><a href='../caja/menufactura2.php'>Facturas</a></li>
              <li><a href='caja/menufproceso2.php'>Facturas en Proceso</a></li>
              ...
              <li><a href='producto/menu.php?id=1'>Productos</a></li>
               <li><a href='reportes/menucompra.php'>Compras Rep</a></li>
            <li><a href='reportes/menuventa.php'>Ventas Rep</a> </li>
          ...
          if ( $n == 5  or $n == 1) {
                            ...
                            <li class='sub'>
            <a href='javascript:;'>
              <i class='fa fa-edit'></i> Compras <div class='pull-right'><span class='caret'></span></div>
            </a>
            <ul class='templatemo-submenu'>
              <li><a href='gastos/menu.php?id=2'></i>Ordenes de Compra</a></li>
           <li><a href='ingresos/menu.php?id=2'></i>Ingresos</a></li>
            ...
            <li><a href='cliente/menu.php?id=2'>Clientes</a></li>
              ...
              <li><a href='producto/menu.php?id=2'>Productos</a></li>
               <li><a href='departamento/menu.php'>Departamento</a></li>
                ...
                <li><a href='reportes/menuocompra.php'>Rep Ordenes de Compra</a></li>
            <li><a href='reportes/menuoventa.php'>Rep Ordenes de Ingreso</a></li>
            <li><a href='reportes/menucompra.php'>Rep Compras </a></li>
          ...
          if ( $n == 6  or $n == 1) {
                            ...
                            <li class='sub'>
            <a href='javascript:;'>
              <i class='fa fa-dollar'></i> Caja <div class='pull-right'><span class='caret'></span></div>
            </a>
            <ul class='templatemo-submenu'>
            <li><a href='caja/menucompra.php?id=2'>Compras</a></li>
            <li><a href='caja/menuventa.php?id=2'>Ventas</a></li>
