...
<div class="navbar navbar-inverse" role="navigation">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content" style="margin: 10px">
...
<h2 style="text-align: center;">REPORTES GASTOS</h2>
...
echo "<h2 style='text-align: center;'><b> Del $FECHAINI<b> AL </b>$FECHAFIN</b> </h2>";
...
where status != 0 and id_departamento = $DEPO and rubro.idRubro = $RUBRO 
and fecha BETWEEN CAST( '$FECHAINI' AS DATE) AND CAST( '$FECHAFIN' AS DATE)
GROUP by id_gastos";
...
echo "<h1 style='text-align: right;'>Total Gasto: $";
